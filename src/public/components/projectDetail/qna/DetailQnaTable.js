...
import DetailQnaPagenation from './DetailQnaPagenation'
...
function createData(id, name, author, created) {
  return {
    id,
    name,
    author,
...
export default function DetailQnaTable() {
  return (
    <>
      <TableContainer
        component={Paper}
