...
import ProducerInfoModal from '../projectPayment/ProducerInfoModal';
import PaymentModalInfo from './ProjectInfoModal';
import ProjectProducer from '../projectPayment/ProjectProducer';
...
export default function ProjectPaymentTable() {
  return (
    <>
      <TableContainer
        component={Paper}
