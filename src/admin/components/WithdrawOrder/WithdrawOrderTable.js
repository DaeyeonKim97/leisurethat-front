...
import WithdrawOrderInfoModal from '../WithdrawOrder/WithdrawOrderInfoModal'
import WithdrawOrderModalInfo from './WithdrawOrderModalInfo'
...
export default function WithdrawOrderTable() {
  return (
    <>
      <TableContainer
        component={Paper}
