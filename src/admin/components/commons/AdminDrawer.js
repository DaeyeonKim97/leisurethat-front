    ...
    >
      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '프로젝트' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '프로젝트 로그' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '결제' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '환불' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '문의' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton
            onClick={handleClick}
            sx={state.opened === '정보제공' ? { bgcolor: '#F1FBFF' } : {}}
          >
            <ListItemIcon>
              <InfoOutlinedIcon />
            </ListItemIcon>
