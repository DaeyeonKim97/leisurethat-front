...
export default function JudgePage(){
    return(
        <section style={{padding : 40, height:'calc(100% - 64px)'}}>
            ...
            <div className="whatsthis" style={{display:'flex', justifyContent:'center', flexDirection:'column', height:"calc(100% - 120px)"}}>

                <section style={{margin:'12px 20px', fontSize:'18px', alignSelf:'flex-end'}}>
