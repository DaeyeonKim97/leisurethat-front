...
function CalculateHistoryForm({ round, currentState, close }) {
                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell align="center">{data.completionDel}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell
                        component="th"
                    ...
                    <TableRow>
                      ...
                      <TableCell align="center">{data.waitingDel}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell
                        component="th"
